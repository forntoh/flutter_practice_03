...
class CustomTypography {
  static TextTheme textTheme = TextTheme(
      headline1: GoogleFonts.alata(fontSize: 96, fontWeight: FontWeight.bold, color: Colors.white),
      headline2: GoogleFonts.alata(fontSize: 60, fontWeight: FontWeight.bold, color: Colors.white),
      headline3: GoogleFonts.alata(fontSize: 48, fontWeight: FontWeight.bold, color: Colors.white),
